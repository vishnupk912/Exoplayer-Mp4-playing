...
public class ReportSubjectActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvhead.setText(studentname+"'s Report");
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject jsonObject)
                    {
                        ...
                        try {
                            ...
                            {
                                Dialog dialog;
                                dialog = new Dialog(ReportSubjectActivity.this);
                            ...
                            SubjectAdapter adapter = new SubjectAdapter(ReportSubjectActivity.this,subModelArrayList);
                            recyclerView_sub.setHasFixedSize(true);
                            recyclerView_sub.setLayoutManager(new GridLayoutManager(ReportSubjectActivity.this,3,RecyclerView.VERTICAL,false));
...

    {
        ...
        public void onBindViewHolder(@NonNull SubjectAdapter.ViewHolder holder, int position)
        {
            ...
            holder.subnametv.setText(position+1 +". "+subname+" Report ");

            holder.lay.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent=new Intent(ReportSubjectActivity.this, ChapterWiseReport.class);
