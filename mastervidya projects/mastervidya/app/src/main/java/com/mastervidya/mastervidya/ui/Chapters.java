                    ...
                    try {
                        ...
                        if(status.contains("success"))
                        {
                            ...
                            for(int i=0;i<jsonArray.length();i++)
                            {
                                ...
                                chapterModel.setMonth(month);
                                chapterModel.setYear(year);
                        ...
                        {
                            Dialog dialog;
                            dialog = new Dialog(Chapters.this);
                        ...
                        {
                            ChapterAdapter adapter = new ChapterAdapter(chapterModelArrayList,Chapters.this);
                            recyclerView.setHasFixedSize(true);
                            recyclerView.setLayoutManager(new LinearLayoutManager(Chapters.this,RecyclerView.VERTICAL,false));
